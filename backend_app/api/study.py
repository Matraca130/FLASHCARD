...
def answer_card(validated_data):
    try:
        ...
        card, session, error_response, status_code = _validate_answer(user_id, card_id, session_id)
        if error_response:
            return error_response, status_code

        review, algorithm = _update_card_and_review(card, session, quality, validated_data)
