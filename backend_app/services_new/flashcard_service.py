...
class FlashcardService(BaseService):
    ...
    def get_flashcard_by_id(self, flashcard_id, user_id):
        ...
        try:
            ...
            flashcard = self.db.session.query(Flashcard).join(Deck).filter(
                and_(
    ...
    def update_flashcard(self, flashcard_id, user_id, update_data):
        ...
        try:
            ...
            allowed_fields = [
                'front_text', 'back_text', 'front_image_url', 'back_image_url',
                'front_audio_url', 'back_audio_url', 'difficulty', 'tags'
            ]
    ...
    def get_flashcards_for_study(self, user_id, deck_id, limit=20):
        ...
        try:
            ...
            return self._success_response({
                ...
                'total_available': len(cards_data)
            })
