...
class DeckCreationSchema(BaseModel):
    ...
    is_public: bool = Field(
        default=False,
        description="Si el deck es público"
    )
    tags: Optional[List[str]] = Field(
        default=[],
        description="Etiquetas del deck"
    )
...
class FlashcardCreationSchema(BaseModel):
    ...
    front_image: Optional[str] = Field(
        None,
        max_length=500,
        description="URL de imagen del frente"
    )
    back_image: Optional[str] = Field(
        None,
        max_length=500,
        description="URL de imagen del reverso"
    )
    front_audio: Optional[str] = Field(
        None,
        max_length=500,
        description="URL de audio del frente"
    )
    back_audio: Optional[str] = Field(
        None,
        max_length=500,
        description="URL de audio del reverso"
    )
    ...
    tags: Optional[List[str]] = Field(
        default=[],
        description="Etiquetas de la carta"
    )
...
class StudySessionSchema(BaseModel):
    ...
    deck_id: int = Field(
        ...,
        gt=0,
        description="ID del deck a estudiar"
    )
    algorithm: str = Field(
        default="fsrs",
