        ...
        try:
            ...
            for card_data in batch_data["flashcards"]:
                try:
                    ...
                    failed_cards.append({"data": card_data, "error": str(e)})
    ...
    def get_due_cards(self, user_id):
        ...
        try:
            ...
            due_cards = (
                ...
                .join(CardReview, Flashcard.id == CardReview.flashcard_id)
            ...
            new_cards = (
                db.session.query(Flashcard)
                .join(Deck, Flashcard.deck_id == Deck.id)
                .outerjoin(CardReview, Flashcard.id == CardReview.flashcard_id)
                .filter(
                    Deck.user_id == user_id,
