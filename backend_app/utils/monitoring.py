...
def init_sentry(app):
    ...
    sentry_sdk.init(
        ...
        traces_sample_rate=MonitoringConfig.PERFORMANCE_SAMPLE_RATE if MonitoringConfig.ENABLE_PERFORMANCE_MONITORING else 0.0,
...
def monitor_api_endpoint(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            logging.error(f"Error en API {method} {endpoint} - Usuario: {user_id} - Tiempo: {execution_time:.3f}s - Error: {str(e)}")
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if execution_time > 1.0:
                    ...
                    sentry_sdk.set_context("slow_query", {
                        "query_name": query,
                        "execution_time": execution_time
                    })
                ...
                sentry_sdk.set_context("db_error", {
                    "query_name": query,
                    "execution_time": execution_time,
                    "error": str(e)
                })
