...
class AuthHelper:
    ...
    def create_tokens_for_user(user: User) -> Dict[str, str]:
        ...
        try:
            ...
            log_user_action('tokens_created', {
                'device_info': device_info,
                'ip_address': ip_address
            }, user.id)
    ...
    def refresh_access_token(refresh_token: str) -> Optional[Dict[str, str]]:
        ...
        try:
            ...
            log_user_action('token_refreshed', {
                'ip_address': AuthHelper.get_client_ip()
    ...
    def revoke_all_user_tokens(user_id: int, reason: str = 'logout_all') -> int:
        ...
        try:
            ...
            log_user_action('all_tokens_revoked', {
                'reason': reason,
                'tokens_count': count
            }, user_id)
    ...
    def validate_token_security(user_id: int, refresh_token: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            if refresh_record.ip_address and refresh_record.ip_address != current_ip:
                log_user_action('suspicious_ip_change', {
            ...
            if (refresh_record.device_info and 
                refresh_record.device_info != current_device):
                log_user_action('device_change', {
