...
class APIResponse:
    ...
    def error(
        ...
        Args:
            ...
            field_errors: Errores específicos por campo (validaciones)
    ...
    @staticmethod
    def forbidden(message: str = "No tienes permisos para realizar esta acción") -> tuple:
        """
...
class ServiceResponse:
    ...
    @staticmethod
    def success(data: Any = None, message: str = "Operación exitosa") -> Dict[str, Any]:
        """
